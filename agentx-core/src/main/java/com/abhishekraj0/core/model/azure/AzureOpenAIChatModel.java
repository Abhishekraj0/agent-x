package com.abhishekraj0.core.model.azure;
...
/**
 * ChatModel implementation for Azure OpenAI using JDK HttpClient and Jackson.
 */
public class AzureOpenAIChatModel implements ChatModel {
    ...
    public AzureOpenAIChatModel(String apiKey, String endpoint, String deploymentName, String apiVersion) {
        this.apiKey = apiKey;
    ...
    public ChatResponse chat(ChatRequest request) {
        try {
            ...
            if (response.statusCode() != 200) {
                throw new RuntimeException("Azure OpenAI API returned status code " + response.statusCode() + ": " + response.body());
            }
            ...
            throw new RuntimeException("Failed calling Azure OpenAI Chat API", e);
        }
    }

    @Override
    public ModelMetadata metadata() {
        return new ModelMetadata(deploymentName, "azure", 128000, false, true);
    }
}
